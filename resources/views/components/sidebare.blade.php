<side class="w-64 bg-yellow-200 shadow-md fixed left-0 top-0 h-full p-4">
    {{-- Logo de l'app --}}
    <h2 class="text-xl text-white font-bold mb-4 pb-4 border-b-2 border-white/30">LOGO</h2>
