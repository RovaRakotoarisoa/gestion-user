        ...
        <p class="text-sm text-gray-500 mt-4 text-center">Formats : JPG, PNG, JPEG – Max 2 Mo</p>
			...
			<div class="space-y-6">
				<div>
					...
					<x-input name="name" type="text" class="w-full pb-3" placeholder="Enter name here..." />
				</div>
				<div>
					<x-label value="Email :" class="pb-3"/>
					<x-input name="email" type="email" class="w-full pb-3" placeholder="Example@gmail.com" />
				</div>
				<div>
					<x-label value="Mot de passe :" class="pb-3"/>
					<x-input name="password" type="password" class="w-full pb-3" />
				</div>
			</div>
