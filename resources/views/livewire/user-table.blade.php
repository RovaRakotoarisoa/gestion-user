<div id="user-table" class="space-y-4">
    <div
        ...
        <div class="flex justify-between items-center">
            <div class="flex flex-row-reverse justify-between items-center bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg !w-[345px]">
                <input
                    wire:model.live.debounce.250ms="search"
                    type="search" 
                    name="search" 
                    placeholder="Search User..."
                    class="bg-gray-50 border-none text-gray-900 text-sm rounded-lg focus:ring-transparent !w-[345px]">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon" class="w-4 h-4 ml-3">
            ...
            <tbody class="divide-y divide-gray-200">
                @foreach($users as $user)
                    <tr x-data="{ modal: false }" x-cloak
                        ...
                        <td class="py-3 text-sm text-gray-600 truncate" title="{{ $user->email }}">
                            {{ $user->email }}
                        </td>
